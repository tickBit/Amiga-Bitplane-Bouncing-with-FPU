...
; I've never used FPU like this before, this something new to me..
;
; This is for Amiga with the 68040 processor
;
; Coded 5/2021
;
...
;------------------------------------------------------------------------------
        ...
        fmove.x  $00,fp7                ; PI
        fmove.x  #0.005,fp1             ; Approximate of one degree in radians
                                        ...
                                        ; ...
                                        ; fadd.x  fp1,fp7
                                        ; ..didn't work with this app ..perhaps later..
        fmul.x   #4,fp1
        fneg.x   fp7
...
scrolltext      dc.b    "MADE WITH BLITTER COPPER AND FPU                              ",0
        even
